<template>
  <div class="flex justify-between items-center border-b py-2">
    ...
    <div class="text-sm text-gray-600">
      রবিবার, ০১ সেপ্টেম্বর ২০২৪, ১০:৩৮ অপরাহ্ন
    </div>
    ...
    <div class="flex">
      ...
      >
        <input
          ...
          name="s"
          class="p-1 border border-gray-300 text-sm text-black focus:outline-none focus:ring-2 focus:ring-black"
        />
        <button
          type="submit"
          class="bg-blue-600 hover:bg-blue-500 py-1 px-2 text-white transition duration-300 ease-in-out"
        >
          সার্চ করুন
        </button>
      </form>
    ...
    <div class="flex space-x-3">
      ...
      <a
        href="https://twitter.com/hostitbd"
        target="_blank"
        class="text-blue-400"
      >
        <svg
      ...
      <a href="https://plus.google.com" target="_blank" class="text-red-500">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 512"
          class="w-6 h-6"
